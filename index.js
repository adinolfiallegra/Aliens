...
function filterInput(event) {
    ...
    // Filters
    if ($dateInput.value) {
        filteredList = filteredList.filter(filterDate);
    };

    if ($cityInput.value) {
        filteredList = filteredSList.filter(filterCity);
    };

    if ($stateInput.value) {
        filteredList = filteredList.filter(filterState);
    };

    if ($countryInput.value) {
        filteredList = filteredList.filter(filterCountry);
    };

    if ($shapeInput.value) {
        filteredList = filteredList.filter(filterShape);
    };
